...
import com.example.mindmeld.adapter.messageAdapter;
import com.example.mindmeld.databinding.ActivityMessagingBinding;
import com.example.mindmeld.model.MessageModel;
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot e : dataSnapshot.child("Contacts").child(receiverId).child("Chats").getChildren()) {
                            ...
                            msgData.add(new MessageModel(e.child("uId").getValue().toString()
                                    , decrypted
                                    , Long.valueOf(e.child("msgTime").getValue().toString())));
